...
func testRawKey(t *testing.T, key string, which string) {
	b, err := hex.DecodeString(key)
	if err != nil {
		t.Fatal("for user %s bad hex: %v", which, err)
	}
	_, err = ReadKeyRing(bytes.NewBuffer(b))
	if err != nil {
		t.Fatalf("for user %s: %v", which, err)
	}
}

func TestKeyHaboutnnah(t *testing.T) {
	testRawKey(t, haboutnnahKey1Raw, "haboutnnah 1")
	testRawKey(t, haboutnnahKey2Raw, "haboutnnah 2")
}
...
const haboutnnahKey1Raw = ""
const haboutnnahKey2Raw = ""
